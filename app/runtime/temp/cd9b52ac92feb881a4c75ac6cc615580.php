...
<div class="box">
  ...
  <table>
    ...
    <tr>
    <td width="10%" class="inputmodify" field="sender_firstname" primarykey="5"><?php echo $val['groupid']; ?></td>
      <td width="30%" class="inputmodify" field="sender_firstname" primarykey="5"><?php echo $val['name']; ?></td>
      <td width="30%" class="inputmodify" field="sender_lastname" primarykey="5"><?php echo $val['add_times']; ?></td>
