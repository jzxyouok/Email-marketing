...
<div class="box">
  <p class="boxtitle">
    <img alt="tag" src="/Public/Images/tag.png">发件人列表  </p>
  <div class="boxitem">
  <table>
    <thead>
    <tr>
    ...
    <tr>
      <td width="20%" class="inputmodify" field="sender_firstname" primarykey="5"><?php echo $val['apikey']; ?></td>
      <td width="20%" class="inputmodify" field="sender_lastname" primarykey="5"><?php echo $val['sendname']; ?></td>
      <td width="20%" class="inputmodify" field="sender_lastname" primarykey="5"><?php echo $val['sendemail']; ?></td>
      <td width="20%" class="inputmodify" field="sender_email" primarykey="5" ><?php echo $val['domain']; ?></td>
      <td width="15%">
