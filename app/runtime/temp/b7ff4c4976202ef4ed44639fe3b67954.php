...
<body id="admin">
	...
	<!-- 核心模块 -->
		...
		<!-- 帮助信息 -->
            ...
            <li>可以使用的模板变量:,
            <span class="red">%recipient_email%</span> 收件人邮箱,
            <span class="red">%recipient_name%</span> 收件人全称
            <span class="red">%recipient_lname%</span> 收信人名字,
            <span class="red">%unsubscribe_url%</span> 发件人邮箱,
            </li>
...
<div class="box">
  <p class="boxtitle">
    <img alt="tag" src="/Public/Images/tag.png">模板添加  </p>
  <div class="boxitem">
        <form action="/themes/themeadd/save" method="post" id="themeform">
            <dl>
                <dt>模板名称</dt>
                <dd><input type="text" name="title" size="25">
                    <span class="red">*</span>
                </dd>
                <br class="cb">
                ...
                <dt>模板内容</dt>
                <dd>
                <textarea name="content" id="theme_content" cols="100" rows="20"></textarea>
