...
<div class="box">
  <p class="boxtitle">
    <img alt="tag" src="/Public/Images/tag.png">添加收件人  </p>
  <div class="boxitem">
        <form action="/accounts/accountadd/save" method="post" id="senderform">
            <dl>
