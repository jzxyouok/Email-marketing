...
<body id="admin">
	...
	<div id="leftbar">
        ...
        <ul class="Senders">
          ...
          <ul class="Senders">
			...
			<li>
				<ul>
				<li><a href="/accounts/accountlist">收件人列表</a></li>
				<li><a href="/accounts/accountgroup">收件人组</a></li>
				<li><a href="/accounts/accountadd">收件人添加</a></li>				</ul>
			</li>
		</ul>
	...
	<!-- 核心模块 -->
		...
		<!-- 帮助信息 -->
          ...
          <li>格式：API Key| 发送人|发送人Email| Domain Name</li>
        	</ol>
				</div>
<style>
.form-control {
...
<div class="box">
  <p class="boxtitle">
    <img alt="tag" src="/Public/Images/tag.png">添加发件人  </p>
  <div class="boxitem">
        <form action="/senders/senderadd/save/" method="post" id="senderform">
            <dl>
                ...
                <label>发件人在这里逐行&nbsp;&nbsp;</label>
                <textarea class="form-control" name="content" rows="18" style="height:400px; width:800px;"></textarea>
            </div>
